CUDA_VISIBLE_DEVICES=1 python test_ugcsr.py \
    ...
    --output_dir /home/data1/NTIRE2025/ShortformUGCSR/submissions_test/PISASR_pretrained_wavelet_align_fusion/synthetic
...
CUDA_VISIBLE_DEVICES=1 python test_ugcsr.py \
    ...
    --output_dir /home/data1/NTIRE2025/ShortformUGCSR/submissions_test/PISASR_pretrained_wavelet_align_fusion/wild